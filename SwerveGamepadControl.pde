// requires GameControlPlus by Peter Lager
...
// this version of the demo is designed to interface with the Logitech F310 controller used in FTC. simply connect it to your computer and run the sketch.
// hopefully it will work, i had lots of trouble getting it to work when i wrote this. Unfortunately, i don't have a controller here at college, so i
// can't test it. sorry.
// controls:
// right stick x-axis is strafe (side to side)
// right stick y-axis is drive (forward and backward)
// left stick x-axis is turn
